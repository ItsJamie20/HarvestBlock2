...
<recipetype:botania:runic_altar>.addRecipe("harvestblock/botania/rune_dark", <item:harvestblock:rune_dark> * 2, 5000, <item:harvestblock:dark_agglomeratio>, <item:mysticalagriculture:prudentium_ingot>, <tag:items:forge:dyes/black>, <item:minecraft:glowstone_dust>, <item:minecraft:coal_block>);
